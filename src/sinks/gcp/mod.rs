...
#[serde(rename_all = "camelCase")]
pub struct GcpMonitoredResource {
    #[serde(rename = "type")]
    pub tpe: String,
    pub labels: HashMap<String, String>,
}
...
#[derive(Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GcpMonitoredResourcedMetadata {
...
pub enum GcpTypedValue {
    Bool { bool_value: bool },
    Int64 { int64_value: String }, // GCP constraint.
    Double { double_value: f32 },
    String { string_value: String },
}

#[derive(Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GcpDistribution {
    pub count: String,
    pub mean: f32,
    pub sum_of_squared_deviation: f32,
}
